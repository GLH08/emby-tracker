...
from app.routers import emby, tmdb, watchlist, stats, auth, history, hero, calendar, progress, recommend, lists, ratings, export, checkin, external_ratings, sync
...
app.include_router(external_ratings.router, prefix="/api")
